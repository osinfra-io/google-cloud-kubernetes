...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_kubernetes_opa_gatekeeper"></a> [kubernetes\_opa\_gatekeeper](#module\_kubernetes\_opa\_gatekeeper) | github.com/osinfra-io/terraform-kubernetes-opa-gatekeeper//regional | dev |
